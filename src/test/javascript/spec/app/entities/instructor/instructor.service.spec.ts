    ...
    describe('Instructor Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/instructors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Instructor', () => {
                service.create(new Instructor(null)).subscribe(received => {
            ...
            it('should update a Instructor', () => {
                service.update(new Instructor(123)).subscribe(received => {
